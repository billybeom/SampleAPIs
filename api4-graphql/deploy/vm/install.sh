#!/usr/bin/env bash
# =============================================================================
# install.sh — Tours GraphQL API (api4-graphql) Linux VM 설치 스크립트
# 대상 OS : RHEL 8/9, Rocky Linux 8/9, Ubuntu 22.04 LTS
# 실행 권한: sudo 또는 root
# =============================================================================
set -euo pipefail

APP_NAME="tours-graphql-api"
APP_DIR="/opt/sample-apis/api4-graphql"
SVC_USER="svcapi"
...
echo "   API 확인    : curl http://localhost:4000/health"
echo "   GraphQL     : curl -X POST http://localhost:4000/graphql -H 'Content-Type: application/json' -d '{\"query\":\"{ cruises { total } }\"}'"
